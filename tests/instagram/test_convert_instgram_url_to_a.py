...
def test_instagram_make_base_url():
    ...
    result = converter_instagram_url.instagram_make_base_url(input_str)
...
def test_instagram_make_author_page():
    ...
    result = converter_instagram_url.instagram_make_author_page(input_usr)
    assert answer == result
...
def test_extract_from_content():
    ...
    """
    answer = "https://www.instagram.com/p/CGEF-ewBxNm"
    result = converter_instagram_url.instagram_extract_from_content(input_content)
...
def test_extract_url():
    ...
    answer = "https://www.instagram.com/p/CGEF-ewBxNm"
    result = converter_instagram_url.extract_url(input_content)
    assert answer == result
